                    ...
                    <div class="row">
                        ...
                        <div class="card">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="kode_jurusan" name="kode_jurusan" value="<?php echo $data['kode_jurusan']; ?>" disabled>
                                </div>
                                <div class="form-group">
                                    <label for="jurusan">Jurusan</label>
                                    <input type="text" class="form-control" id="jurusan" name="jurusan" value="<?php echo $data['jurusan']; ?>" disabled>
                                </div>
                                <a href="index.php" class="btn btn-danger mt-1">Kembali</a>
                            </form>
                                </div>
                                <div class="col-md-6">
                                <img src="../ASSET/logo.png" alt="" width="30%" class="text-end">
                                </div>
                                </div>
                            </div>
                        </div>
